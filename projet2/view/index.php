            ...
            <div class="col-md-6 mb-4">
                <div class="card bg-secondary text-white border-0 shadow-lg">
                    ...
                    <div class="card-body">
                        ...
                        <a href="admin_login.php" class="btn btn-primary">Adhérer à INFOLAB</a>
                        <a href="admin_login.php" class="btn btn-primary">voir plus</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 mb-4">
                <div class="card bg-secondary text-white border-0 shadow-lg">
                    ...
                    <div class="card-body">
                        ...
                        <a href="admin_login.php" class="btn btn-primary">Adhérer à ENACTUS</a>
                        <a href="admin_login.php" class="btn btn-primary">voir plus</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 mb-4">
                <div class="card bg-secondary text-white border-0 shadow-lg">
                    ...
                    <div class="card-body">
                        ...
                        <a href="admin_login.php" class="btn btn-primary">Adhérer à FAHMOLOGIA</a>
                        <a href="admin_login.php" class="btn btn-primary">voir plus</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 mb-4">
                <div class="card bg-secondary text-white border-0 shadow-lg">
                    ...
                    <div class="card-body">
                        ...
                        <a href="admin_login.php" class="btn btn-primary">Adhérer à RADIO_ESSECT_FM</a>
                        <a href="admin_login.php" class="btn btn-primary">voir plus</a>
                    </div>
                </div>
            </div>
